<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCContacts.ascx.cs" Inherits="Jobhunt.UserControls.UCContacts" EnableViewState="true" %>
       <br>
...
<asp:Panel ID="pnlCustomPager" runat="server">
 ...
 <asp:Label ID="lContacts" runat="server" Text="" Font-Bold="True"></asp:Label>