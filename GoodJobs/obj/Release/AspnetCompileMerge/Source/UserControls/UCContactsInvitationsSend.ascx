<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCContactsInvitationsSend.ascx.cs" Inherits="Jobhunt.UserControls.UCContactsInvitationsSend" EnableViewState="true" %>
...
<asp:Label ID="lContactsInvitationsSend" runat="server" Text="" Font-Bold="True"></asp:Label>